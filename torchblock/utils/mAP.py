...
def mAP(pred_boxes, true_boxes, iou_threshold=0.5, box_format="corners", num_classes=20):
    ...
    Parameters:
        pred_boxes (list): [[img_idx, class_pred, prob, x1, y1, x2, y2], ...]
        true_boxes (list): [[img_idx, class_true, prob, x1, y1, x2, y2], ...]
    """
    # pred_boxes (list): [[train_idx, class_pred, prob, x1, y1, x2, y2], ...]
    # true_boxes (list): [[train_idx, class_true, prob, x1, y1, x2, y2], ...]
    average_precisions = []
    epsilon = 1e-6
